...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.execute("ALTER TABLE home_graph1 ALTER COLUMN client SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph1 ALTER COLUMN office SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph1 ALTER COLUMN level SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph1 ALTER COLUMN condition SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph1 ALTER COLUMN gender SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph1 ALTER COLUMN age SET DEFAULT 'ALL'")
        
        db.execute("ALTER TABLE home_graph2 ALTER COLUMN client SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph2 ALTER COLUMN office SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph2 ALTER COLUMN level SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph2 ALTER COLUMN condition SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph2 ALTER COLUMN gender SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph2 ALTER COLUMN age SET DEFAULT 'ALL'")
        
        db.execute("ALTER TABLE home_graph3 ALTER COLUMN client SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph3 ALTER COLUMN office SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph3 ALTER COLUMN level SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph3 ALTER COLUMN condition SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph3 ALTER COLUMN gender SET DEFAULT 'ALL'")
        db.execute("ALTER TABLE home_graph3 ALTER COLUMN age SET DEFAULT 'ALL'")
